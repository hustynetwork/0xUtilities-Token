...
contract OxUtilities is Context, IERC20, Ownable {
    ...
    address payable public RevenueShareWallet;
    
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal =  1000000000 * 10**_decimals; 
    string private constant _name = "0xUtilities";
    string private constant _symbol = "0xU";

    uint256 private SwapTokens = _tTotal * 3 / 10000;
    uint256 private maxSwapTokens = _tTotal * 1 / 100;
    ...
    constructor () {
        ...
        MarketingWallet = payable(0xcD6ae50d24Eec2eb5302963b83F97A93E3eD0e17);
        DevelopmentWallet = payable(0x5D97Fb9E78fE3e082e0DB2D1eA36bc35102C34Ef);
        RevenueShareWallet = payable(0x3dEb040366D83003800B1945a14A92baCAC95af9);
        ...
        _isExcludedFromFee[RevenueShareWallet] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        MarketingWallet.transfer(amount*2/5);
        DevelopmentWallet.transfer(amount*2/5);
        RevenueShareWallet.transfer(amount*1/5);
    }
    ...
    function setRevenueShareWallet(address payable _newWallet) external onlyOwner {
        require(_newWallet != address(this), "CA will not be the Fee Reciever");
        require(_newWallet != address(0), "0 addy will not be the fee Reciever");
        RevenueShareWallet = _newWallet;
        _isExcludedFromFee[_newWallet] = true;
        emit FeesRecieverUpdated(_newWallet);
    }
    ...
    function updateThresholdToken(uint256 minToken, uint256 maxToken) external onlyOwner {
